...
SPRING_CONFIG="META-INF/dev-plat-common/spring/springWeb-start.xml"
fi
...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS -classpath $CONF_DIR:$LIB_JARS com.sooying.dev.plat.common.shell.SpringMain $SPRING_CONFIG> $STDOUT_FILE 2>&1 &
